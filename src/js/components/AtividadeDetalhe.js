                                    ...
                                    <div className="row d-flex align-items-center">
                                        ...
                                        <div className="mt-5 mb-5 row justify-content-center align-self-center">
                                            <div className="m-2 row align-items-center primary-btn primary white-text pedido justify-content-center blue-btn">
                                                    ...
                                                    <Link className="btn-style white-text font-weight-bold text-uppercase link-no-decoration d-flex align-items-center justify-content-center" to={{pathname: '/review/', state: { user: viagem }} }>
                                                    <span>Confirmar</span>
                                                    </Link>
                                            </div>
                                        </div>
