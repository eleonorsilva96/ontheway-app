                        ...
                        <div className="container-fluid">
                            <form>
                                ...
                                <div className="ml-1 pl-3 row justify-content-center">
                                    <select className="custom-select custom-select-lg col-5 m-2 font-weight-normal">
                                        <option value="1">Grande&nbsp;(até 50kg)</option>
                                        <option value="2">Médio&nbsp;(até 30kg)</option>
                                        <option value="3">Pequeno&nbsp;(até 10kg</option>
                                    </select>
                                    <input type="text" placeholder="€" className="col-2 m-2 form-control-lg text-center"/>
                                ...
                                <div className="spacing-bottom spacing-top-b row justify-content-center align-self-center">
                                    <div className="m-2 row align-items-center primary-btn primary white-text pedido justify-content-center blue-btn">
                                        <Link className="d-flex justify-content-center align-items-center link-no-decoration white-text text-uppercase font-weight-bold" to="/pedido/">
                                            Pesquisar
                                        </Link>
                                    </div>
                                </div>
